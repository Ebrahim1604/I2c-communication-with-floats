...
void handle_data_request(double* data2master)
{
  if(Wire.read() == 0x06)
  {
    Serial.println("Master Data request acknowledged!");
    }
   ...
   //i2c_send(I2C_MASTER_ADDR,s2m,(4*no_of_values+3));
   i2c_send(I2C_MASTER_ADDR,s2m,32);
   //master_response = 0;
